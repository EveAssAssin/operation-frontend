// pages/billing/BillingDeptSummaryPage.jsx
// 部門開帳總表：按月查看「全部部門」各門市養護/報修/教育訓練/廣告費等費用彙總
...
export default function BillingDeptSummaryPage() {
